package com.atguigu.cloud.wxpay.request;


import com.atguigu.cloud.wxpay.config.WXPayConfig;
import com.atguigu.cloud.wxpay.config.WxGroupConfig;
import com.atguigu.cloud.wxpay.entity.WXPayConstants;
import com.atguigu.cloud.wxpay.utils.SpringUtil;
...
public class WXPayReport {
    ...
    private WXPayReport(final WXPayConfig config) {
        ...
        this.wxGroupConfig = (WxGroupConfig) SpringUtil.getBean("wxGroupConfig");
        // 添加处理线程
    ...
    public void report(String uuid, long elapsedTimeMillis,
        ...
        ReportInfo reportInfo = new ReportInfo(uuid, currentTimestamp, elapsedTimeMillis,
                firstDomain, primaryDomain, firstConnectTimeoutMillis, firstReadTimeoutMillis,
                firstHasDnsError, firstHasConnectTimeout, firstHasReadTimeout);
        String data = reportInfo.toLineString(wxGroupConfig.getWxPayKey());
