...
import com.atguigu.cloud.oauth2.utils.UserJwt;
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if(authentication==null){
            ...
            if(clientDetails!=null){
                ...
                //数据库查找方式
                return new User(username,clientSecret, AuthorityUtils.commaSeparatedStringToAuthorityList("admin"));
            }
        }
...
//        String pwd = userFeign.findByUsername(username).getData().getPassword();
        //111111
        String pwd = "$2a$10$TJ4TmCdK.X4wv/tCqHW14.w70U3CC33CeVncD3SLmyMXMknstqKRe";
        //创建User对象  授予权限.GOODS_LIST  SECKILL_LIST
        String permissions = "goods_list,seckill_list,resource";
